---
title: OSC Obtains Stay Returning Navy Safety Manager to Job Pending Fuller Investigation
permalink: /news/pages/17-08-osc-obtains-stay-returning-navy-safety-manager/
...
OSC may request a stay from the MSPB when there are reasonable grounds to believe that a prohibited personnel practice has been committed. A grant of a stay request is not a finding on the merits of the claim. The MSPB’s stay order, which contains further details, can be [found here](https://www.mspb.gov/mspbsearch/viewdocs.aspx?docnumber=1400415&version=1405843&application=ACROBAT).  
